...
The following guide has been tested on Ubuntu 20.04 with GCC 9.3.0 and CMake 3.16.3. 
...
Experiment data and code to generate the figures in the paper can be found in https://github.com/detock/DetockAnalysis
